...
class GraphPPIS_Trainer(BaseTrainer):
    ...
    def train(self):
        task_desc = 'GraphPPIS 二分类' if self.task_type == 'binary' else 'GraphPPIS 多标签'
        print("=" * 60)
    ...
    def _save_results(self, final_metrics, best_epoch):
        ...
        with open(out_file, 'a') as f:
            ...
            f.write(f"  model: {getattr(self.args, 'model', 'GraphPPIS')}\n")
