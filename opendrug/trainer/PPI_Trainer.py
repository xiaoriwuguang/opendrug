"""
PPI (Protein-Protein Interaction) Trainer

支持:
- PPI 二分类: BCEWithLogitsLoss / CrossEntropyLoss
...
class PPI_Trainer(BaseTrainer):
    ...
    def train(self):
        task_desc = 'PPI 二分类' if self.task_type == 'binary' else 'PPI 多标签'
        print("=" * 60)
    ...
    def _save_results(self, final_metrics, best_epoch):
        ...
        with open(out_file, 'a') as f:
            ...
            f.write(f"  model: {getattr(self.args, 'model', 'PPI')}\n")
