...
用于 DTIAM 模型的训练，支持 DTI 分类和 DTA 回归任务。
...
class DTIAM_Trainer(BaseTrainer):
    """
    DTIAM 训练器
    ...
    def train(self):
        ...
        print("\n" + "=" * 60)
        print(f"DTIAM 训练完成 ({task_name}) - 最终测试结果")
        print("=" * 60)
    ...
    def _save_results(self, final_metrics, best_epoch):
        ...
        with open(out_file, 'a') as f:
            ...
            f.write(f"  model: {getattr(self.args, 'model', 'DTIAM')}\n")
